			...
			<div className="container mx-auto min-h-[calc(100vh-77px) flex items-center relative}">
				<div className="flex-col lg:flex-row flex gap-10 lg:mx-10 py-20">
					...
					<div className="space-y-6">
						...
						>
							<div className="flex gap-2 items-center bg-white text-black px-4 py-2 mb-6 hover:bg-[gray]">
								<BsPlayFill size={24} />
								Watch Trailer
							</div>
						</div>
				...
				>
					<div className="flex items-center justify-between hg-black text-white p-3.5">
